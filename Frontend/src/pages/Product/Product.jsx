...
//   const sizeContainerRef = useRef(null); // 🔹 to detect clicks outside
...
//   // 🔹 Effect to clear size if clicked outside
//   useEffect(() => {
//     const handleClickOutside = (event) => {
//       if (
//         size && // only run if some size is selected
//         sizeContainerRef.current &&
//         !sizeContainerRef.current.contains(event.target)
//       ) {
//         setSize(""); // deselect size
//       }
//     };
